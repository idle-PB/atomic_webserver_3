...
Procedure Atomic_Server_Init_MimeTypess(*Atomic_server.Atomic_Server) 
  ...
  *Atomic_server\MimeTypes("doc") = "application/msword"
  *Atomic_server\MimeTypes("eps") = "application/postscript"
  *Atomic_server\MimeTypes("exe") = "application/octet-stream"
  *Atomic_server\MimeTypes("json") = "application/json"
  *Atomic_server\MimeTypes("pdf") = "application/pdf"
  *Atomic_server\MimeTypes("ps") = "application/postscript"
  *Atomic_server\MimeTypes("rtf") = "application/rtf"
  *Atomic_server\MimeTypes("xhtml") = "application/xhtml+xml"
  *Atomic_server\MimeTypes("xsl") = "application/xml"
  *Atomic_server\MimeTypes("xslt") = "application/xml"
  ...
  *Atomic_server\MimeTypes("wav") = "audio/wav"
  ...
  *Atomic_server\MimeTypes("svg") = "image/svg+xml"
  *Atomic_server\MimeTypes("tif") = "image/tiff"
  *Atomic_server\MimeTypes("tiff") = "image/tiff"
  
  *Atomic_server\MimeTypes("wrl") = "model/vrml"
  
  *Atomic_server\MimeTypes("pbh") =  "text/html"
  *Atomic_server\MimeTypes("js") =  "text/javascript"
  *Atomic_server\MimeTypes("css") = "text/css"
  *Atomic_server\MimeTypes("csv") = "text/csv"
  *Atomic_server\MimeTypes("htm") = "text/html"
  *Atomic_server\MimeTypes("html") = "text/html"
  *Atomic_server\MimeTypes("sgm") = "text/sgml"
  *Atomic_server\MimeTypes("shtm") = "text/html"
  *Atomic_server\MimeTypes("shtml") = "text/html"
  *Atomic_server\MimeTypes("txt") = "text/plain"
  *Atomic_server\MimeTypes("xml") = "text/xml"
  *Atomic_server\MimeTypes("sass") = "text/x-sass" 
  *Atomic_server\MimeTypes("scss") = "text/x-scss" 
  *Atomic_server\MimeTypes("pb") = "text/plain"
  *Atomic_server\MimeTypes("pbi") = "text/plain"
  ...
  *Atomic_server\MimeTypes("ppt") = "application/x-mspowerpoint"
  *Atomic_server\MimeTypes("xls") = "application/x-msexcel"
...
Declare Atomic_Server_BuildRequestHeader(Server,*Buffer, DataLength, ContentType.s,status.i=200)  
...
Procedure Atomic_Server_Init(title.s,wwwDirectory.s,IP.s="127.0.0.1",domain.s="",port=80,IpVer=#PB_Network_IPv4,maxclients=5000,*pCBPost=0,*pCBGet=0) 
  ...
  *atomic_server= AllocateStructure(Atomic_Server) 
  ...
  If *atomic_server 
    ...
    *Atomic_Server\URIHandlers("favicon")\pt = @*Atomic_Server_favicon() 
...
Procedure Atomic_Server_ProcessURIRequest(server,*request.Atomic_Server_Request,Requestfile.s) 
  ...
  If FindMapElement(*Atomic_Server\URIHandlers(),Requestfile)
    ...
    *BufferOffset = Atomic_Server_BuildRequestHeader(server,*FileBuffer, FileLength, *request\ContentType,*request\status)
...
Procedure Atomic_Server_ProcessRequest(*request.Atomic_Server_Request)
  ...
  If *request\type  
    ...
    *request\host = Mid(request,start,Position-start); + "/"
    ...
    EndIf
    Trim(*request\Host," ") 
    If (FindString(*request\host,"127.0.0.1") = 0 And FindString(*request\host,"localhost") = 0 And FindString(*request\Host,"[::1]")=0) 
    ...
    If (IsWindow(Atomic_Server_Log_window\window) And *Atomic_Server\blog)
      *msg =  UTF8("Client IP " + IPString(GetClientIP(*Atomic_Client\ID)) + " load " + *request\RequestedFile + " client " + Str(*Atomic_Client\ID) + " time " + FormatDate("%hh:%ii:%ss",_DateUTC())) 
      ...
      EndIf   
    EndIf       
    If Atomic_server_Reverse_Proxy(*request) = 0
      fn = ReadFile(-1, *Atomic_Server\WWWDirectory + *request\RequestedFile,#PB_UTF8 | #PB_File_SharedRead)
      If fn   
        FileLength = Lof(fn)
        *request\status = 200 
        If FindMapElement(*Atomic_server\MimeTypes(),GetExtensionPart(*request\RequestedFile)) 
        ...
        EndIf 
      Else
        If Atomic_Server_ProcessURIRequest(*Atomic_Server,*request,*request\RequestedFile) <> #True 
          If Atomic_Server_ProcessURIRequest(*Atomic_Server,*request,"error") <> #True 
            fn = ReadFile(-1, *Atomic_Server\WWWDirectory + *Atomic_Server\WWWError, #PB_UTF8 | #PB_File_SharedRead)
            If fn 
              *request\status = 404 
              FileLength = Lof(fn)
              ContentType = "text/html"        
    ...
    If fn 
      *FileBuffer = AllocateMemory(FileLength + 200)
      If GetExtensionPart(*request\RequestedFile) = "pbh" 
        *preprocess  = AllocateMemory(FileLength)
        ReadData(fn, *preprocess, FileLength)
        *output = Atomic_Server_Preprocess(*preprocess,FileLength,*request)
        FileLength = MemorySize(*output)
        *FileBuffer   = AllocateMemory(FileLength + 200)
        *BufferOffset = Atomic_Server_BuildRequestHeader(*Atomic_Server,*FileBuffer, FileLength, ContentType,*request\status)
...
Procedure Atomic_Server_BuildRequestHeader(*Atomic_Server.Atomic_Server,*FileBuffer, FileLength, ContentType.s,Status.i=200)
